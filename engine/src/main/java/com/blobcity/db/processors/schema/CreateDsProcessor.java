 ...
 * @author sanketsarang
 */
public class CreateDsProcessor extends AbstractCommitProcessor implements Processor {

    public CreateDsProcessor(final Query query) {
        super(query);
    }
    ...
    public void rollback() {
        ...
        try {
            if(doesRollbackNeedAction()) {
                super.getBean(BSqlDatastoreManager.class).dropDsNoArchive(super.query.getString(QueryParams.DATASTORE));
            }
